...
const Cart = () => {
  ...
  return (
    <>
      <div className="container flex justify-around items-start flex-wrap mx-auto mt-8  margine-btn-phone page-ltr   overflow-x-hidden ">
        {cartItems.length === 0 ? (
          <div>
